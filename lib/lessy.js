module.exports = (function(){
	...
	return function(ouput,imports){
		if(!ouput && !util.isString(output)) throw new Error('Please Specific your Output folder location');
		...
		var o = app;
		o.outputFolder(ouput);
		o.importFolder(imports || '.');
	};
