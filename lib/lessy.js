module.exports = (function(){
	...
	return function(output,imports){
			...
			app.sync = function Sync(set,endpoint){
				...
				return this.watch(endpoint,point,function(){
					...
					return self.parser.parse(data,function(e,tree){
						if(e){ self.log.crisis = 1; self.log.error(e.message ? e.message : e);  self.log.crisis = 0; return; }
						self.log.log("   Sync'ing: {0}".grey,set.green);
